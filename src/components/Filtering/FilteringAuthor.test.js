...
import FilteringAuthor from './FilteringAuthor';

configure({adapter: new Adapter()});

describe('FilteringAuthor', () => {
  it('should render the authFilter class', () => {
    const wrapper = shallow(<FilteringAuthor books={[{
      isbn: '9781593275846',
...
describe('FilteringAuthor', () => {
  it('should render the author correctly', () => {
    ...
    expect(wrapper.contains('Marijn Haverbeke')).toEqual(true);
  });
});